        ...
        <div class="col-sm-9">
            <div class="panel panel-primary">
                ...
                <div class="panel-footer">Welcome... to Project Wiki: The Project Archive</div>
            </div>

            <div class="row">
                <div class="col-sm-6">
                    <div class="well">
                        <h4>Your Project Work</h4>
                        <p> <?php echo($this->mine); ?>  </p>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="well">
                        <h4>All Project Work </h4>
                        <p> <?php echo($this->all); ?>  </p>
                    </div>
                </div>
                    ...
                    <div class="box-body">
                        ...
                        <?php } else {
                            ...
                            <div class="alert alert-info alert-dismissible">
                                ...
                                <p>Instruction: Here is where you can add your project work</p>
                            </div>
                        <?php } ?>
